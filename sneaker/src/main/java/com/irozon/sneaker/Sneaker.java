...
public class Sneaker implements View.OnClickListener {
    ...
    private static OnCancelClickListener mCancelClickListener = null;
    private static Typeface mTypeFace = null;

    // add 添加按钮操作的支持
    private static boolean isShowCancelBtn = false;
     ...
     * @return
     */
    public Sneaker setCancelButtonShow(boolean isShowCancel) {
        isShowCancelBtn = isShowCancel;
        return this;
    }
     ...
     * @return
     */
    public Sneaker setCancelButtonContent(String btnContent) {
        if (isShowCancelBtn) {
            btnTitle = btnContent;
        }
        return this;
    ...
    public Sneaker setOnCancelClickListener(OnCancelClickListener listener) {
    ...
    private void sneakView() {
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                mHeight == DEFAULT_VALUE ? (getStatusBarHeight() + convertToDp(56)) : convertToDp(mHeight));
        ...
        LinearLayout.LayoutParams lpTv = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        if (!mTitle.isEmpty()) {
...
//        }
        ...
        LinearLayout.LayoutParams btnLayoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        btnLayoutParams.weight = 1;
        // 垂直居中靠右显示
        btnLayoutParams.gravity = Gravity.CENTER_VERTICAL | Gravity.END;
        btnLayout.setLayoutParams(btnLayoutParams);
        btnLayout.setOrientation(LinearLayout.VERTICAL);
        LinearLayout.LayoutParams lpBtn = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        lpBtn.gravity = Gravity.RIGHT | Gravity.END;
        if (isShowCancelBtn) {
            Button btnCancel = new Button(getContext());
